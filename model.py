...
def normalized_column_initializer(weights, std = 1.0):
    ...
    out *= std / torch.sqrt(out.pow(2).sum(1, keepdim=True))  #in this stage, we get var(out) = std^2
    return out
...
class ActorCritic(nn.Module):
    ...
    def __init__(self, num_inputs, action_space):
        ...
        self.critic.weight.data = normalized_column_initializer(self.critic.weight.data, std=1.0)
