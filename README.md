...
An A3C implementation to ace the Breakout game by Atari, modified with the addition of a Dueling Network for improved performance
...
**Future Enhancements:**
   - UNREAL Algorithm (to beat A3C + Dueling Network) 
