...
from model_dueling import ActorCritic  # version dueling


# no exploration in the testing phase
def test(rank, params, shared_model, model_type="dueling"):
    ...
    while True:
        ...
        with torch.no_grad():
            _value, q_values = model(state.unsqueeze(0))  # dueling returns value and q_values
        ...
        if done:
            ...
            # Save test results
            with open("results_dueling.txt", "a") as f:
